...
class SPARQLStreamWrapper(object):
    ...
    :ivar agent: The User-Agent for the HTTP request header. The **default** value is an autogenerated string using the SPARQLStreamWrapper version code.
    ...
    def __init__(self, endpoint, updateEndpoint=None, returnFormat=XML, defaultGraph=None, agent=__agent__):
        ...
        :param agent: The User-Agent for the HTTP request header. The **default** value is an autogenerated string using the SPARQLStreamWrapper version number.
        :type agent: string
        """
    ...
    def isSparqlUpdateRequest(self):
        """ Returns ``True`` if SPARQLStreamWrapper is configured for executing SPARQL Update request.

        :return: Returns ``True`` if SPARQLStreamWrapper is configured for executing SPARQL Update request.
        :rtype: bool
        """
        return self.queryType in [INSERT, DELETE, CREATE, CLEAR, DROP, LOAD, COPY, MOVE, ADD]

    def isSparqlQueryRequest(self):
        """ Returns ``True`` if SPARQLStreamWrapper is configured for executing SPARQL Query request.

        :return: Returns ``True`` if SPARQLStreamWrapper is configured for executing SPARQL Query request.
        :rtype: bool
        """
    ...
    def __str__(self):
        """This method returns the string representation of a :class:`SPARQLStreamWrapper` object.
...
class QueryResult(object):
    ...
    generated by a :func:`SPARQLStreamWrapper.query` call. The results can be
    ...
    * ``info()`` that returns the meta-information of the HTTP result as a dictionary-like object.
    ...
    def __init__(self, result):
        """
        :param result: HTTP response stemming from a :func:`SPARQLStreamWrapper.query` call, or a tuple with the expected format: (response, format).
        """
